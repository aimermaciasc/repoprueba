...
x += (xTo - x)/ 25;// esto permite ir actualizando el posicionamiento de la camara, entre mas lejos este la camara del objeto a seguir mas rapido se movera
y += (yTo - y)/ 25;// entre mas se vaya accercando mas lento sera su movimiento, la division de 25 permitira la velocidad de movimiento de la camara
